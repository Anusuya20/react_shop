...
exports.forgotPassword = catchAsyncErrors(async(req,res,next) =>{
   ...
   try{
      ...
      await sendMail({
          email:user.email,
          subject:`LifeStyle Garments Password Recovery`,
          message,
      });
...
exports.updateProfile = catchAsyncErrors(async(req,res,next) =>{
   ...
   // we add cloudinary letter then we are giving conditions for the avatar
...
exports.deleteUser = catchAsyncErrors(async(req,res,next) =>{
   ...
   // we remove cloudinary letter then we are giving conditions for the avatar
  const user = await User.findById(req.params.id);
